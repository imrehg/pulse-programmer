...
-- TO REGISTERS
   ...
   register_write : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst = '0') then 
...
-- R26 (LOW)
   R26 : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst = '0') then 
       if (ResetRegFile) then
         r26h <= (others =>'0');
...
-- R27 (HIGH)
   R27 : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst = '0') then 
       if (ResetRegFile) then
         r27h <= (others =>'0');
...
-- R28 (LOW)
   R28 : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst = '0') then 
       if (ResetRegFile) then
         r28h <= (others =>'0');
...
-- R29 (HIGH)
   R29 : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst ='0') then 
       if ResetRegFile then
         r29h <= (others =>'0');
...
-- R30 (LOW)
   R30 : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst = '0') then 
       if ResetRegFile then
         r30h <= (others =>'0');
...
-- R31 (HIGH)
   R31 : process(clk, nrst, clk_en, sclr)
   begin
     if (nrst = '0') then 
       if ResetRegFile then
         r31h <= (others =>'0');
