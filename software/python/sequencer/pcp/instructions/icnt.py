...
class InputCounter_Instr(InstructionWord):
	...
	SUBOPCODE_MASK			= Bitmask(label="Subopcode", width=3, shift=20)
	...
	#----------------------------------------------------------------------------
	def set_masks(register_width, register_shift, subopcode_witdh, subopcode_shift,
	...
	def __init__(self, register, subopcode, address):
		...
		check_inputs([(register, InputCounter_Instr.REGISTER_MASK),
					  ...
					  (address, InputCounter_Inst.ADDRESS_MASK)])
	...
	def get_constant(self):
		return self.ADDRESS_MASK.get_shifted_value(self.address)
	#----------------------------------------------------------------------------
	def __str__(self):
