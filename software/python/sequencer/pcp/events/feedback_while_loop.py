# Module : feedback_while_loop
# Package: pcp.events
# Class definition for a feedback while loop event.

from sequencer.pcp.events import *
from sequencer.pcp.events.feedback_branch import *

#==============================================================================
class FeedbackWhileLoop_Event(Sequence_Event):
  """
  Base class for an abstract feedback while loop event.
  """
  #----------------------------------------------------------------------------
